...
namespace Sunlighter.AsyncQueueLib
{
    ...
    public abstract class AcquireReadSucceeded : AcquireReadResult
    {
        ...
        public BigInteger Offset { get { return offset; } }
    ...
    public sealed class AcquireReadSucceeded<T> : AcquireReadSucceeded
    {
        ...
        public ImmutableList<T> Items { get { return items; } }
    }
    ...
    public sealed class AcquireWriteSucceeded : AcquireWriteResult
    {
        ...
        public int ItemCount { get { return maxItemCount; } }
        ...
        public Task<AcquireWriteResult> AcquireWriteAsync(int desiredSpace, CancellationToken ctoken)
        {
            ...
            else
            {
                lock(syncRoot)
                {
                    ...
                    {
                        return Task.FromResult<AcquireWriteResult>(new AcquireWriteFaulted(new InvalidOperationException("Attempting to acquire more space than will ever become available")));
                    }
                    else
                    {
